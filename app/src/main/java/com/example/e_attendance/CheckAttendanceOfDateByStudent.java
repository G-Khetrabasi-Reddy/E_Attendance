...
public class CheckAttendanceOfDateByStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_attendance_of_date_by_student);
        ...
        viewButton.setOnClickListener(v -> {
            ...
            if (!selectedDate.isEmpty()) {
                ...
                Intent intent = new Intent(CheckAttendanceOfDateByStudent.this, StudentListViewAttendanceByDate.class);
                intent.putExtra("subject_id", subjectId);
                intent.putExtra("date", selectedDate);
                startActivity(intent);
            } else {
                Toast.makeText(CheckAttendanceOfDateByStudent.this, "Please Select Date ", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        FirebaseDatabase.getInstance().getReference("class").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(CheckAttendanceOfDateByStudent.this, "Error retrieving classes: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        classSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(CheckAttendanceOfDateByStudent.this, "Selected Class: " + selectedClass, Toast.LENGTH_SHORT).show();
            }
        ...
        semesterSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(CheckAttendanceOfDateByStudent.this, "Selected Semester: " + selectedSemester, Toast.LENGTH_SHORT).show();
            }
        ...
        dateIcon.setOnClickListener(v -> {
            ...
            DatePickerDialog datePickerDialog = new DatePickerDialog(CheckAttendanceOfDateByStudent.this,
